...
Процедура ТестовыеДанные()
	Объект.ПутьДоКаталогаСправки = "D:\SB\develop\platform-context\helpers\shcntx";	
	
	НоваяЗапись = Объект.Платформы1С.Добавить();
	НоваяЗапись.Платформа = Перечисления.ВерсииПлатформы.Версия_8_3_10;
	НоваяЗапись.КаталогСоСправкой = "D:\SB\develop\platform-context\helpers\shcntx\8.3.10";
